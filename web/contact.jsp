<%-- 
    Document   : contact
    Created on : 25 Sep, 2017, 9:52:54 AM
    Author     : Mrunal
--%>
...
<html>
    ...
    <body bgcolor="000FFFFF" link="green" alink="purple" vlink="yellow">
        ...
        <div class="right" id="right_side">
            <b><span style="color:green"><center><h2>Contact:</h2></center></span></b><br/>
            <p><h3>Phone No - 022-89745373,76584590,78453279</h3></p><br/>
            <p><h3>E-mail us at - <a href="mailto: www.frcrce@gmail.com">www.frcrce@gmail.com</a></h3></p>
        </div>
    </body>
</html>