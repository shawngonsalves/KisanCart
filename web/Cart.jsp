<%-- 
    Document   : Cart
    Created on : 25 Sep, 2017, 2:44:23 PM
    Author     : Mrunal
--%>
...
<html>
    ...
    <body bgcolor="000FFFFF" link="green" alink="purple" vlink="yellow">
        ...
        <div class="right" id="right_side">
            <table bgcolor="white" border=2 height=30%>
                ...
                <tr>
                    ...
                    <td> Quantity</td>
                    <td> Cost </td>
                    <td><input type="checkbox" > Delete Item</td>
                </tr>
                <tr>
                    <td colspan=5><font color="Brown">Total Cost =</font></td><td colspan=2></td>
                </tr>
            </table>
            <br>
