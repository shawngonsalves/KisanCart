<%-- 
    Document   : CFrontPage
    Created on : 26 Sep, 2017, 10:00:30 AM
    Author     : Mrunal
--%>
...
<html>
    <head>
        ...
        <title>Customer Front Page</title>
        <style>
	    h1 { color: red;}
	    h2 { color: purple;}
	    h3 { color: yellow;}
	...
	<div class="right" id="right_side">
            ...
            <form method="POST">
                <input type="textbox" value="Name" style="width:300px; border-width:0px; height:100px; font-size:20px; background-color:pink;" readonly="readonly" />
                <input type="button" value="My Orders" onclick="location.href='Cart.jsp'" style="width:300px; border-width:0px; height:104px; font-size:20px;" /><BR>
                <input type="textbox" value="B-33, Symphony CHS Ltd." style="width:300px; border-width:0px; height:100px; font-size:16px; background-color:pink;" readonly="readonly" />
            ...
            <BR><BR>
            <center>
                <input type="button" onclick="location.href='Vegetables.jsp'" value="Shop Now!" style="width:300px; border-width:0px; height:100px; font-size:20px;" /><BR>
            </center>
            </form>
	</div>
    </body>
